        ...
        <div class="wrapper">
            ...
            <div class="leftside-menu">
                ...
                <a href="/dashboard" class="logo text-center logo-light">
                    <h3 class="text-white">IMMOBILIER</h3>
                </a>
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar="">
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-title side-nav-item">Gerance</li>

                        <li class="side-nav-item">
                            <a href="{{ route('proprietaires.index') }}" class="side-nav-link">
                                <i class="uil-user"></i>
                        ...
                        <li class="side-nav-item">
                            <a href="{{ route('biens.index') }}" class="side-nav-link">
                                <i class="uil-home"></i>
                                <span> Biens </span>
                            </a>
                        </li>
                        ...
                        <li class="side-nav-title side-nav-item">Locations</li>
                        ...
                        <li class="side-nav-title side-nav-item">Gestion des Utilisateurs</li>
